...
<h3 class="card-title">Edit ACCOUNT <small>check account</small></h3>
</div>


<form id="quickForm" method="get" action="<?= site_url('Admin/Account_internal_edit'); ?>">
<div class="card-body">
    ...
    <div class="form-group mb-0">
        ...
        <label class="custom-control-label" for="exampleCheck1">I agree to the <a href="#">EDIT</a>.</label>
        </div>
    </div>
</div>
